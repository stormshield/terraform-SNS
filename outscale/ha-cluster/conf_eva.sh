...
#FILTER
$SETCONF $CF/object Service sshrdr 2222/tcp
$SETCONF $CF/object Host server $SERVERIP
...
separator color="c0c0c0" comment="Server redirection" collapse="0"
pass from any on wan to Firewall_wan port sshrdr -> to server port ssh  # rdr to server
